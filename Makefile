...
patch: node_modules lint usercss
	yarn -s run versions -pdC patch github-dark-extensions.css github-dark-extensions.user.css
	git push --tags origin master

minor: node_modules lint usercss
	yarn -s run versions -pdC minor github-dark-extensions.css github-dark-extensions.user.css
	git push --tags origin master

major: node_modules lint usercss
	yarn -s run versions -pdC major github-dark-extensions.css github-dark-extensions.user.css
	git push --tags origin master
